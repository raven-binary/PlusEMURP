...
namespace Plus.HabboHotel.Roleplay.Corporation.Hospital
{
    class HealCommand : IChatCommand
    {
        ...
        public void Execute(GameClient Session, Room Room, string[] Params)
        {
            ...
            if (TargetClient.GetRoleplay().Energy == 0)
            {
                ...
                User.GetClient().Shout("*Eats a bar of chocolate [+50% Energy]*");
            ...
            else if (TargetClient.GetHabbo().Health != Session.GetHabbo().HealthMax)
            {
                ...
                {
                    User.GetClient().Say("*Gives " + TargetClient.GetHabbo().Username + " antibiotics and treats the deepest wounds*");
