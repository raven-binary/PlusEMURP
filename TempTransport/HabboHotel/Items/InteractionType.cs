    ...
    public class InteractionTypes
    {
        public static InteractionType GetTypeFromString(string pType)
        {
            switch (pType.ToLower())
            {
                ...
                case "fish":
                    return InteractionType.FISH;
                case "sellfish":
                    return InteractionType.SELLFISH;
                case "taxi":
                    return InteractionType.TAXI;
                case "shop":
                    return InteractionType.SHOP;
                case "farm":
                    return InteractionType.FARM;
                case "lockpick":
                    return InteractionType.LOCKPICK;
                case "crosstrainer":
                ...
                case "sellweapon":
                    return InteractionType.SELLWEAPON;
                case "phonestore":
                    return InteractionType.PHONESTORE;
                case "cafe":
                    return InteractionType.CAFE;
                case "hospital":
                    return InteractionType.HOSPITAL;
                case "slot":
                ...
                case "bin":
                    return InteractionType.BIN;
                case "bank_menu":
                    return InteractionType.BANKMENU;
                case "police":
                    return InteractionType.POLICE;
                case "apple_energy":
                    return InteractionType.APPLEENERGY;
                case "corp_task":
                    return InteractionType.CORPTASK;
                case "armoury":
                    return InteractionType.ARMOURY;
                case "robcash":
                    return InteractionType.ROBCASH;
                case "corphack":
                    return InteractionType.CORPHACK;
                case "infoterminal":
                ...
                case "actionpoint":
                    return InteractionType.ACTIONPOINT;
                case "lovelock":
