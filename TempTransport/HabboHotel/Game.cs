...
namespace Plus.HabboHotel
{
    public class Game
    {
        ...
        private readonly Discord.DiscordManager _discordManager;
        ...
        public Game()
        {
            ...
            RoleplayDataManager.Init(); //roleplay
            ...
            _discordManager = new Discord.DiscordManager();
        }
        ...
        public Discord.DiscordManager GetDiscordManager()
        {
            return _discordManager;
        }
