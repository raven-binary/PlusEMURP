...
namespace Plus.HabboHotel.Rooms.Chat.Commands.Moderator
{
    class UserInfoCommand : IChatCommand
    {
        ...
        {
            get { return "View information from a citizen."; }
        }
        ...
        public void Execute(GameClients.GameClient Session, Rooms.Room Room, string[] Params)
        {
            if (Params.Length == 1)
            {
                Session.SendWhisper("Invalid syntax :userinfo <citizen name>");
                return;
            }
            ...
            if (UserData == null)
            {
                Session.SendNotification("The citizen could not be found.");
                return;
            }
